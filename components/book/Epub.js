...
import { ireader } from '../../config/bootstarp';
import { Auth } from 'aws-amplify';
var oauth = require("oauth-sign");

const Epub = ({bookMedia, changeAudioPlayerStatus, changeRatingsPopUpStatus, ratingsExists}) => {
  ...
  let cancelAudio = () => {
    ...
    useEffect(() => {
        ...
        var params = {
          ...
          lti_version: "LTI-1p0",
          context_id: uuidv4(),
          oauth_consumer_key: ireader.consumerKey,
          ...
          user_id: Auth.user.attributes.email,
          launch_id: "product",
          product_code: bookMedia,
        };
    ...
    return (
        <div id="myModal" className="modal">
            ...
            <div className="modal-content">
                <span onClick={cancelAudio} className="close">&times;</span>
                <iframe name="epub-frame" style={{width: "100%"}} height="600" width="100%"></iframe>
                <form id="ltiForm"  target='epub-frame'></form>
            </div>        
            <style jsx>{`
             body {
                margin: 0;
