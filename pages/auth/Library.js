...
const ageGroups = [
    ...
    {
        "_id": "5e4e2482803ef7134e2d24234",
        "group": "4-6 years"
    },
    {
        "_id": "5e4e2482803ef712342342ff3",
        "group": "7-9 years"
    },
    {
        "_id": "5e4e2482803ef713sgsf23422",
        "group": "10-12 years"
    },
    {
        "_id": "5e4e2482803ef713sgsf23422",
          ...
          <div className="bg-green-light flex min-h-screen">
            <div className="container mx-auto my-4 md:my-14 md:px-14 px-4 w-full justify-center content-center">
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 mt-4 mb-5 mx-30 my-30">
                  <div className="relative text-gray-600 focus-within:text-gray-400 flex justify-center mb-4">
                     <div className="relative inline-block text-left dropdown">
                        ...
                        <select name="age" id="age" className="inline-flex justify-center w-52 text-left rounded-md border border-gray-300 shadow-sm px-2 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-blue-800">
                  ...
                  <div className="relative text-gray-600 focus-within:text-gray-400 flex justify-center mb-4">
                     <div className="relative inline-block text-left dropdown">
                        ...
                        <select name="region" id="region" className="inline-flex justify-center w-52 text-left rounded-md border border-gray-300 shadow-sm px-2 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-blue-800">
                  ...
                  <div className="relative text-gray-600 focus-within:text-gray-400 flex justify-center mb-4">
                     <div className="relative inline-block text-left dropdown">
                        ...
                        <select name="type" id="type" className="inline-flex justify-center w-52 text-left rounded-md border border-gray-300 shadow-sm px-2 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-blue-800">
                  ...
                  <div className="relative text-gray-600 focus-within:text-gray-400 flex justify-center mb-4">
                     <div className="relative inline-block text-left dropdown">
                        ...
                        <select name="language" id="language" className="inline-flex justify-center w-52 text-left rounded-md border border-gray-300 shadow-sm px-2 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-blue-800">
               ...
               <div className="w-full justify-center flex">
                  <a href="#" className="rounded w-full mb-4 inline-flex justify-center border-2 shadow-sm px-11 py-2 bg-gradient-to-r from-purple-bright to-purple-bright text-small4 font-semibold text-white hover:from-purple-darkest hover:to-blue-bright focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-red-100 sm:w-auto sm:text-small4 font-sans">Load more</a>
               </div>
            </div>
          </div>
        </Layout>
