                  ...
                  <div className="mt-0 md:mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 justify-items-center md:justify-items-start">
                     <div className="mx-0 md:mr-40">
                        <div className="relative h-auto w-64 px-4 py-10 md:p-0 sm:shadow-sm md:shadow-xl flex justify-center mb-0 md:mb-10 md:mt-2 img-author">
                           <img className="" src="/img/books/Book5.jpg" width={250} height={385} alt="image" />
                     ...
                     <div className="mb-10 md:mb-0 col-span-1 md:col-span-1 lg:col-span-2">
                        ...
                        <p className="text-small2 font-medium text-white font-serif mb-4">{authorDetails.totalBooks}</p>
                        <p className="text-small2 font-medium text-white font-serif">{authorDetails.desc}</p>
                     </div>
                  </div>
               </div>
            </div>
                                 ...
                                 <div className="grid grid-cols-6 gap-4">
                                    <div className="col-start-1 col-end-7 flex justify-center">
                                       <h3 className="text-left text-white font-sans font-semibold mb-5 text-center">
                                          <p className="text-6xl font-bold text-blue-800 font-serif mt-2 tracking-wide leading-8">Books by this Author</p>
                                       </h3>
                                    </div>
                                 </div>
                                 <div className="flex flex-wrap justify-center">
                                    {otherBooksByAuthor.map(function (book, index) {
                                    return (
