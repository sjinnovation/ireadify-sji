...
import { createPrivacyPolicy } from '../../../api/privacy/mutations'
...
const add = () => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            await API.graphql(graphqlOperation(createPrivacyPolicy, { input: inputData }))
    ...
    return (
        ...
        <Layout>
            <SuccessAlert show={successAlert} fade={fade} message={"Privacy Policy added"} hideAlert={onAlertButtonClose} animateAlert={onAlertAnimationEnd} />
                        ...
                        <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="flex flex-wrap -mx-3 mb-6">
                                <div className="w-full px-3">
                                    ...
                                    />
                                     <textarea value={ckContent} ref={register({ required: true, minLength: 3, validate: (value) => { return !!value } })} name="content" className="appearance-none block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-grey"
                                       style={{display: "none"}} type="text" placeholder="Content" />
