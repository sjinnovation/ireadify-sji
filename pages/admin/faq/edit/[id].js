...
import { updateFaq } from '../../../../api/faq/mutations'
import useSWR from 'swr'
import { getFaq as GetFaq } from '../../../../api/faq/queries';
...
const Edit = () => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            await API.graphql(graphqlOperation(updateFaq, { input: inputData }))
    ...
    return (
        ...
        <Layout>
            <SuccessAlert show={successAlert} fade={fade} message={"FAQ details updated."} hideAlert={onAlertButtonClose} animateAlert={onAlertAnimationEnd} />
                                        ...
                                        <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
                                            <div className="flex flex-wrap -mx-3 mb-6">
                                                <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                                    ...
                                                    <div className="relative">
                                                        <select defaultValue={faq.data.getFaq.topic} name="topic" ref={register({ required: true, validate: value => value !== 'select' || 'error message' })} className="block appearance-none w-full bg-grey-200 border border-grey-200 text-grey-darker py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-grey">
                                                ...
                                                <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                                    ...
                                                    <input defaultValue={faq.data.getFaq.question} ref={register({ required: true, maxLength: 50, minLength: 3, validate: (value) => { return !!value.trim() } })} name="question" className="appearance-none block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-grey"
                                            ...
                                            <div className="flex flex-wrap -mx-3 mb-6">
                                                <div className="w-full px-3">
                                                    ...
                                                    <textarea defaultValue={faq.data.getFaq.answer} ref={register({ required: true, minLength: 10, validate: (value) => { return !!value.trim() } })} name="answer" className="appearance-none block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-grey"
